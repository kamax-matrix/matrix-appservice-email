...
public class Outlook2016ClientFormatterTest {

    private Outlook2016ClientFormatter formatter = new Outlook2016ClientFormatter();

    @Test
    public void testPlain() throws IOException {
        File f = new File("src/test/resources/outlook2016Content.txt");
    ...
    public void testHtml() throws IOException {
        File f = new File("src/test/resources/outlook2016Content.html");
        assertTrue(f.getAbsolutePath(), f.canRead());
